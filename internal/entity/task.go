...
type Task struct {
	ID               uuid.UUID       `json:"id"`                // 任务的唯一 ID (可以由 Asynq 生成或我们自己生成)
	...
	FileID           *uuid.UUID      `json:"file_id"`           // 关联的文件 ID (如果任务与特定文件相关)
...
// taskID 可以是 Asynq 生成的 ID，或者我们自己生成的 UUID。
func NewTask(taskID uuid.UUID, taskType string, userID string, payload map[string]interface{}) (*Task, error) {
